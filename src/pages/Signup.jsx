                ...
                <div className="grid md:grid-cols-2 min-h-150">
                    ...
                    <div className="p-12 flex flex-col justify-center">
                        <div className="mb-8">
                            ...
                            <p className="text-zinc-400">Create your account to continue</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                            <div>
                                ...
                                />
                                {errors.firstName && ( // If 1st condtion true return 2nd else return 1st which is 0 or emptys-> &&
                            ...
                            >
                                {loading? 'Signing U':'Sign Up'}
                            </button>
                        </form>
                        <p className="text-zinc-500 text-sm text-center mt-6">
                            Already have an account?{" "}
                            <Link to="/login" className="text-emerald-400 hover:text-emerald-300 transition-colors hover:underline">
                                Login
                            </Link>
                        </p>
                    </div>
